 ...
 *
 */
public class ShopRecommendShopRequest<T> extends TaobaoRequestImpl<ShopRecommendShopResponse> {
	...
	public ShopRecommendShopRequest() {
		this.methodName = "taobao.shoprecommend.shops.get";
	}
